...
function BGSection({ data }) {
  return (
    <>
      <div class="relative h-[20vh] md:h-[60vh] group overflow-hidden  flex items-center justify-center">
        <img
          src={data.img}
          alt={data.img + 'Image'}
        ...
        <div class="absolute inset-0 flex flex-col justify-end mb-8 md:mb-24">
          <div className="bg-white/15 text-left p-2 md:p-8 backdrop-blur-3xl rounded-e-full max-w-max">
            <h1 class="text-white text-xl md:text-7xl  font-bold">
              {data.title}
            </h1>
          </div>
