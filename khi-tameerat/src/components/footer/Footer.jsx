      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-3 gap-8 sm:gap-12 lg:gap-40 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-[#9ED220]">
                Links
              </h2>
              <ul className="text-gray-300 text-[13px]">
                <li className="mb-2">
            ...
            <div>
              ...
              <ul className="text-gray-300 space-y-2 text-[13px]">
                <li>Email</li>
                <li>Phone Number</li>
                <li>Phone Number</li>
              </ul>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a href="#" className="text-[#aaaaaa] hover:text-white ms-5">
              <svg
                className="w-4 h-4"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
